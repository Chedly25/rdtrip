    ...
    <AnimatePresence>
      {showFloatingButton && (
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          onClick={openAgent}
          className="fixed bottom-6 right-6 z-50 w-16 h-16 bg-[#064d51] text-white rounded-full shadow-2xl flex items-center justify-center hover:bg-[#0a6b70] transition-colors"
        >
