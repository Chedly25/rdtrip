...
const SpotlightV2 = () => {
  ...
  return (
    <div className="h-screen w-screen overflow-hidden bg-gray-50 relative">
      ...
      {/* Collaborate Button - Fixed position (above AI chat button, clear of city cards) */}
      {routeId && (
        <motion.button
          onClick={() => setShowCollaboration(!showCollaboration)}
          className="fixed bottom-72 right-6 z-50 bg-blue-600 hover:bg-blue-700 text-white rounded-full p-4 shadow-lg transition-all flex items-center gap-2"
